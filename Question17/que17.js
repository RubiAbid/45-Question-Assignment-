...
while (invitation.length > 2) {
    var newlist = invitation.pop();
    console.log("sorry ".concat(newlist, " I can't invite you to dinner"));
}
console.log("Invitation to last 2 guests");
invitation.forEach(function (newlist) { return console.log(" Hey ".concat(newlist, " you are still invited to dinner")); });
invitation.pop();
invitation.pop();
